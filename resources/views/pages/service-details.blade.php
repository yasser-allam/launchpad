...
@section('main-content')
    <div id="cover"
        class="overflow-hidden h-[35vw] relative ">
    ...
    'svg' => 'assets/icons/service-details/test.svg',
    'title' => 'UI/UX Design',
    ...
    <div class="w-full bg-black ">
        <div class="w-11/12 mx-auto text-white mt-20">
            <div class="flex flex-col gap-y-10 ">
                ...
                <div class="flex items-center w-full h-full gap-x-20 ml-10 mb-32">
    ...
    'fit' => 'cover',
                    ...
                    <div class="flex flex-col gap-y-6 w-[40%]">
                        <span class="uppercase font-black text-5xl leading-relaxed">Title of the step goes here</span>
                        <p class="font-thin text-sm leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing
                        ...
                        <br>
                        <p class="font-thin text-sm leading-relaxed">
