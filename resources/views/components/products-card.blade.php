<a wire:wirenavigate href="/product-details" class="product-card group {{ $gradient }}">
    ...
    <div class="absolute top-[20%] sm:top-[40%] lg:top-[30%] 2xl:top-[63%] left-[5%] w-[80%]">
        <span class="uppercase text-2xl md:text-xl 2xl:text-xl text-white font-bold">{{ $title }}</span>
    </div>
    <div class="absolute bottom-[10%] left-[5%] w-[80%]">
        <p class="font-thin text-white/70 lg:text-[10px] 2xl:text-[15px] mt-10">{{ $description }}</p>
    </div>
</a>
